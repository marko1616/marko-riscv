...
template<typename T, typename U = T> U read_data(const uint8_t *data, size_t offset, std::endian endianness);
...
public:
   ...
   */
    enum class SectionFlags : uint64_t {
        ...
        SHF_EXCLUDE = 0x8000000       // Section is excluded unless referenced (GNU)
    };
