...
class alignas(VL_CACHE_LINE_BYTES) VMarkoRvCore VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    VL_IN8(&clock,0,0);
    VL_IN8(&reset,0,0);
    VL_IN8(&io_memio_read_addr_ready,0,0);
    VL_OUT8(&io_memio_read_addr_valid,0,0);
    VL_OUT8(&io_memio_read_data_ready,0,0);
    VL_IN8(&io_memio_read_data_valid,0,0);
    VL_IN8(&io_memio_write_req_ready,0,0);
    ...
    VL_OUT64(&io_memio_write_req_bits_data,63,0);
    VL_OUT64(&io_pc,63,0);
